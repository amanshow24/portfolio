...
export default function NavigationBar() {
    ...
    return (
        <nav className="fixed w-full top-0 flex px-6 md:px-16 h-16 bg-background text-foreground justify-between items-center border-b-4 border-foreground z-50 transition-colors duration-300">
            {/* Logo (small boxed, like the original Z_) */}
            <a href="#home" className="flex items-center justify-center h-10 w-10 border-2 border-foreground bg-card p-1 shadow-[3px_3px_0px_0px_var(--foreground)] select-none">
                <img src="/portfolio_logo.png" alt="Portfolio logo" className="h-6 w-6 object-contain" />
            </a>
